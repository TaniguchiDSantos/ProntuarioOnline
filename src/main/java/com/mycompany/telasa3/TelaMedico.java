...
public class TelaMedico extends javax.swing.JFrame {
    ...
    public TelaMedico() {
        ...
        medicos = medicoObject.listaMedicos();
        DefaultTableModel model = (DefaultTableModel) jTable1.getModel();
        model.setRowCount(0);
        if (medicos != null) {
            for (final Medico medico : medicos) {
                model.addRow(new Object[]{medico.getNome(), medico.getCpf(), medico.getCrm(), medico.getEspecialidade(), medico.getTelefone(), medico.getIdade(), medico.getCep(), medico.getEstado(), medico.getCidade(), medico.getBairro(), medico.getRua(), medico.getNumero()});
            }
        }

    }

    public TelaMedico(String id, String nome, String tipoAcesso) {
        initComponents();
        List<Medico> medicos = new ArrayList<Medico>();
        Medico medicoObject = new Medico();
        medicos = medicoObject.listaMedicos();
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Nome", "CPF", "CRM", "Especialidade", "Telefone", "Idade", "CEP", "Estado", "Cidade", "Bairro", "Rua", "Número"
            }
        ));
        ...
        jPanelSearchFieldLayout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanelSearchFieldLayout.createSequentialGroup()
                ...
                .addComponent(jTextSearch, javax.swing.GroupLayout.DEFAULT_SIZE, 379, Short.MAX_VALUE))
        );
                ...
                .addGroup(jPanelGeralLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    .addGroup(jPanelGeralLayout.createSequentialGroup()
                        ...
                        .addGroup(jPanelGeralLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                            .addGroup(javax.swing.GroupLayout.Alignment.LEADING, jPanelGeralLayout.createSequentialGroup()
                                .addComponent(jLabel6)
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                                .addComponent(jLabelAddIcon, javax.swing.GroupLayout.PREFERRED_SIZE, 32, javax.swing.GroupLayout.PREFERRED_SIZE))
    ...
    private void jLabelSearchIconMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabelSearchIconMouseClicked
        ...
        Medico medicoObject = medico.consultaMedico(jTextSearch.getText());
        DefaultTableModel model = (DefaultTableModel) jTable1.getModel();
        if (medicoObject != null) {
            model.setRowCount(0);
            model.addRow(new Object[]{medicoObject.getNome(), medicoObject.getCpf(), medicoObject.getCrm(), medicoObject.getEspecialidade(), medicoObject.getTelefone(), medicoObject.getIdade(), medicoObject.getCep(), medicoObject.getEstado(), medicoObject.getCidade(), medicoObject.getBairro(), medicoObject.getRua(), medicoObject.getNumero()});
        }
    ...
    private void jLabelAddIconMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabelAddIconMouseClicked
        ...
        new TelaMedico_Cadastro(jLabelIDHide.getText(), jLabelNome.getText(), jLabelTipoAcesso.getText()).setVisible(true); // Open the Second.java window
        dispose();
